...
2. **Προσοχή στο να τηρείτε τη βασική δομή ενός προγράμματος.** 1) Δήλωση και αρχικοποίηση μεταβλητών, 2) Είσοδος δεδομένων (με scanner) και data binding (εκχώρηση σε μεταβλητή), 3) Εκτύπωση αποτελεσμάτων. 
