1. **Για να αναλύετε μία διαδικασία μπορείτε**: 1) να χρησιμοποιείται Παραδείγματα Χρήσης (ΠΧ) (Use Cases), ή/και 2) Activity Diagram. 
...
3. Η εφαρμογή ελέγχει αν το έτος διαιρείται με το 4 Ή αν το έτος δεν διαιρείται με το 100.  
